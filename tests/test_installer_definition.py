...
def test_release_version_is_037_everywhere():
    ...
    assert metadata["project"]["version"] == "0.37.0"
    assert '__version__ = "0.37.0"' in package
    assert '#define MyAppVersion "0.37.0"' in installer
