...
def test_release_version_is_041_everywhere():
    ...
    assert metadata["project"]["version"] == "0.42.0"
    assert '__version__ = "0.42.0"' in package
    assert '#define MyAppVersion "0.42.0"' in installer
